...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            Passenger passenger1 = new Passenger("Amelia", "Turner",745632455l,LocalDate.of(2023, 11, 14), true);
            Passenger passenger2 = new Passenger("Mitchell", "Foster",342453454l,LocalDate.of(2023, 11, 16), true);
            Passenger passenger3 = new Passenger("Sebastian ", "Reynolds",566632455l,LocalDate.of(2023, 11, 16), true);
            Passenger passenger4 = new Passenger("Isabella", "Rivera",77222455l,LocalDate.of(2023, 11, 15), true);
            ...
            Set<Passenger> psngr = new HashSet<>();
